...
export class ReelConfig
{
    ...
    public get GridSize(): IPoint { return this.option.gridSize; }
    public get Extra(): number { return this.option.extra; }
    public get Spacing(): IPoint { return this.option.spacing; }
    public get Count(): number { return this.GridSize.y + this.Extra * 2; }
    ...
    { 
        return {x: tileSize.x * config.GridSize.x, y: tileSize.y * config.GridSize.y};
    }    
}
